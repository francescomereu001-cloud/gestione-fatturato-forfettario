...
test("unclassified imports affect neither income nor expenses", () => assert.deepEqual(cashflowSummary([item("unclassified", 100), item("unclassified", -30)]), { income: 0, expenses: 0, cashflow: 0 }));
